  ...
  ask traders [
    ...
    if (tradeStatus = "Transact")[
      if countticks > (speed + tradeSpeedAdjustment)  [
        ...
        if (typeOfTrader = "LiqBuyBkr" and sum [sharesOwned] of traders with [typeOfTrader = "LiqBuyBkr"] < LiqBrk_Limit) [
          LiqBuyBkrStrategy
...
;==============================================================================
;=========== liquidity_broker_agent BEHAVIORAL SPECIFICATION ==================
;==============================================================================
...
to LiqBuyBkrStrategy
 ...
 ; Prevent Broker from crossing inventory limit
  if(tradeQuantity + sharesOwned  > LiqBrk_Limit)[
   set tradeQuantity (LiqBrk_Limit - sharesOwned)
  ]
