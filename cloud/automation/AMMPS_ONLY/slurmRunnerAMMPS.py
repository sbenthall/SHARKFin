...
def get_azSecrect(keyVaultName, secrectName):
	...
	retrieved_secret_string = "DefaultEndpointsProtocol=https;AccountName=sbsimulationdata;AccountKey=KR3zmvCUXKMgW6TZwdUhnfPBGdOr65p24cMvLW1vB6IIp3A18ikgIOit11eQHTjcEDA6KHLglPIz+AStqYXzJQ==;EndpointSuffix=core.windows.net"
